...
const DoctorDashboard = () => {
  ...
  return (
   <div className={`flex flex-col min-h-[100vh] gap-5 px-4 sm:px-6 pb-6 pt-[100px] transition-all duration-300 ${sidebar ? "pl-[200px] md:pl-[200px]" : "pl-[60px] md:pl-[60px]"}`}>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-white">
    ...
    <div className="flex items-center gap-4 bg-[#5C67F2] p-4 rounded-xl shadow-sm">
      ...
      <div>
        ...
        <p className="text-xl sm:text-2xl font-bold">$2,450</p>
      </div>
    </div>
    ...
    <div className="flex items-center gap-4 bg-[#5C67F2] p-4 rounded-xl shadow-sm">
      ...
      <div>
        ...
        <p className="text-xl sm:text-2xl font-bold">35</p>
      </div>
    </div>
  ...
  <div className="mt-5 w-full overflow-x-auto">
    ...
    <table className="min-w-[600px] w-full text-sm sm:text-base text-gray-700 border-collapse">
      <thead className="bg-gray-100 font-semibold text-sm sm:text-base">
        <tr>
          <th className="text-left px-4 py-2 whitespace-nowrap">Patient</th>
          <th className="text-left px-4 py-2 whitespace-nowrap">Payment</th>
          <th className="text-left px-4 py-2 whitespace-nowrap">Booking Date</th>
          <th className="text-left px-4 py-2 whitespace-nowrap">Status</th>
          <th className="text-center px-4 py-2 whitespace-nowrap">Actions</th>
        </tr>
      </thead>
      <tbody>
        {appointments.slice(start, end).map((apt) => (
          <tr key={apt.id} className="border-b text-sm sm:text-[15px]">
            ...
            <td className="px-4 py-3 whitespace-nowrap ">{apt.payment}</td>
            <td className="px-4 py-3 whitespace-nowrap">{apt.date}</td>
            <td className="px-4 py-3 font-semibold whitespace-nowrap">
              ...
              {apt.status === "Pending" && <span className="text-yellow-500">Pending</span>}
            </td>
