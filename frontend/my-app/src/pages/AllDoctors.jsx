...
const doctors = [
    { name: "Dr. Smith", img: "https://randomuser.me/api/portraits/men/66.jpg", speciality: "Cardiologist" },
    { name: "Dr. Alice", img: "https://randomuser.me/api/portraits/men/66.jpg", speciality: "Neurologist" },
    { name: "Dr. Alice", img: "https://randomuser.me/api/portraits/men/66.jpg", speciality: "Neurologist" },
    { name: "Dr. Alice", img: "https://randomuser.me/api/portraits/men/66.jpg", speciality: "Neurologist" },
    { name: "Dr. Alice", img: "https://randomuser.me/api/portraits/men/66.jpg", speciality: "Neurologist" },
    { name: "Dr. Alice", img: "https://randomuser.me/api/portraits/men/66.jpg", speciality: "Neurologist" },
...
const AllDoctors = () => {
    ...
    return (
        <div className={`${sidebar ? "pl-[200px]" : "pl-[60px]"} transition-all duration-300 pt-25 p-5 min-h-screen`}>
            <h1 className="text-3xl font-bold text-indigo-700 mb-6">All Doctors</h1>
            {loading ? <Loader /> : <><div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-5">
                {doctors.slice(start, end).map((doc, idx) => (
                    ...
                    >
                        ...
                        <label className="flex items-center justify-center gap-2 mt-4">
                            <input type="checkbox" className="accent-violet-500" /> Available
                        </label>
                    </div>
                ))}
            </div>
